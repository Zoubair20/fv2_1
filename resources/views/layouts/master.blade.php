...
<div id="afterload" style="display: none">
    ...
    <header id="header" class="fixed-top header-transparent text-dark">
        ...
        <div class="container text-dark">
            ...
            <!-- Uncomment below if you prefer to use an image logo -->
                <a class="pr-5" href="/"><img src="{{asset('/')}}storage/logos/logo-black-150.png"
                                              alt="logo firstviewagency" class="img-fluid"></a>
            </div>

            <nav class=" h2 nav-menu d-none d-lg-block">
                <ul>
                    <li class="{{ request()->is('/') ? 'active' : '' }}"><a href="/">{{__('master.nav_accueil')}}</a>
                    </li>
                    <li class="drop-down {{ request()->is('nos-services*') ? 'active' : '' }}"><a
                            href="/nos-services">{{__('master.nav_nos_Services')}}</a>
                        <ul>
                    ...
                    <li class="drop-down  {{ request()->is('nos-profils*') ? 'active' : '' }}"><a
                            href="/nos-profils">{{__('master.nav_nos_profils')}}</a>
                        <ul>
                    ...
                    <li class=" {{ request()->is('contact') ? 'active' : '' }}"><a
                            href="/contact">{{__('master.nav_contact')}}</a></li>
                    <li class="pl-5 {{ request()->is('demander-un-devis') ? 'active' : '' }}"><a
                            href="/demander-un-devis">{{__('master.nav_online_quote')}}</a></li>
    ...
    <footer id="footer">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <button class="btn btn-fv" type="submit" onclick="window.open('{{asset("Brochure-FirstViewAgency.pdf")}}')"><i
                                class='bx bx-download'></i> TELECHARGER NOUS BROCHURE
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-info">
                        ...
                        <table class="footer-info">
                            ...
                            <tr>
                                ...
                                <td><a class="text-white" target="_blank" href="tel:+212524422327">+(212) 524 422
                                        327</a></td>
                            </tr>
                            <tr>
                                <td><i class="bx bx-md bxl-whatsapp"></i></td>
                                <td><a class="text-white" target="_blank" href="https://wa.me/0033758872302">+(33) 758
                                        872 302</a></td>
                            </tr>

                            <tr>
                                <td><i class="bx bx-md bx-envelope"></i></td>
                                <td><a class="text-white" target="_blank" href="mailto: contact@firstviewagency.com">contact@firstviewagency.com</a>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-lg-4 col-md-6 footer-info">
                        <table class="footer-info">
                            ...
                            <tr>
                                <td><i class="bx bx-md bx-phone-call"></i></td>
                                <td><a class="text-white" target="_blank" href="tel:+212661101564">+(212) 661 101
                                        564</a></td>
                            </tr>
                            <tr>
                                <td><i class="bx bx-md bx-envelope"></i></td>
                ...
                <nav class="border border-secondary navbar navbar-expand-sm  navbar-dark justify-content-center p-0">
                    ...
                    <ul class="navbar-nav list-group-horizontal">
                        <li class="border-right border-left border-secondary nav-item  px-3 {{ request()->is('blog') ? 'active' : '' }}">
                            <a class="nav-link" href="/blog">{{__('master.nav_blog')}}</a></li>
                        <li class="border-right border-secondary nav-item px-3 {{ request()->is('recrutement') ? 'active' : '' }}">
                            <a class="nav-link" href="/recrutement">{{__('master.nav_recrutement')}}</a></li>
        ...
        <div class="container">
            <div class="copyright">
                <a href="https://www.firstviewagency.com/"><b>FirstViewAgency</b></a><span> Copyright &copy;  2018-{{now()->year}}.</span>
                All Rights Reserved
            </div>
        </div>
