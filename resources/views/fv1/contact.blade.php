                ...
                <div class="col-lg-6 order-1 order-md-2">
                    ...
                    <form action="{{url('/contact')}}" method="POST" role="form" class="php-email-form shadow-none">
                        ...
                        <div class="form-group">
                            <input type="tel" class="form-control" name="tel" id="tel" placeholder="{{__('contact.placeholder_tel')}}"
                                data-rule="minlen:10" data-msg="Veuillez saisir au moins 10">
                            <div class="validate"></div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="objet" id="subject" placeholder="{{__('contact.placeholder_objet')}}"
                        ...
                        <div class="text-center"><button class="btn-fv" type="submit">{{__('contact.b_envoyer')}}</button></div>
                    </form>
                </div>
